...
**Commands:** `init`, `list`, `search`, `create-template`, `publish`, `validate-template`, `update`, `tui`

## Build — Configure and run

Define your tasks, wire them into pipelines, and set your defaults. This is where `fledge.toml` lives.

**Commands:** `run`, `lane`, `config`
...
Check your code before it ships. AI review, codebase Q&A, environment diagnostics, code metrics, and dependency health — all from the terminal.

**Commands:** `review`, `ask`, `doctor`, `metrics`, `deps`
...
Install community plugins, write your own, and set up shell completions. fledge is designed to be extended.
