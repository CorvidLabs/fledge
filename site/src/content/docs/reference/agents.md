---
title: "Using fledge with AI agents"
section: "Reference"
order: 4
---
...
The canonical short-form entrypoint for agents lives at [AGENTS.md](https://github.com/CorvidLabs/fledge/blob/main/AGENTS.md) in the repository root. This page is its long-form companion. Point agents to either. For how specs work and why they matter, see [Spec: Spec-sync](../spec).
