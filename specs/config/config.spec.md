...
| Export | Description |
|--------|-------------|
| `Config` | Top-level configuration struct with `defaults` and `templates` sections |
| `Defaults` | Struct holding author, GitHub org, and license default values |
| `TemplatesConfig` | Struct holding additional template directory paths |
...
| Type | Description |
|------|-------------|
| `Config` | Top-level config with `defaults` and `templates` sections |
| `Defaults` | Author, GitHub org, and license defaults |
| `TemplatesConfig` | Additional template directory paths |
